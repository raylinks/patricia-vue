                            ...
                            <section class="panel">
                                <div class="panel-body noradius padding-10">
                                    ...
                                    <figure class="margin-bottom-10"><!-- image -->
                                        <img class="img-responsive" src="assets/images/demo/9_full.jpg" alt="" />
                                    </figure><!-- /image -->
                                    ...
                                    <div id="overview" class="tab-pane active">
                                        ...
                                        <form class="well">
                                            ...
                                            <div class="margin-top-10">
                                                ...
                                                <a href="#" class="btn btn-link profile-btn-link" data-toggle="tooltip" data-placement="bottom" title="Add a Location"><i class="fa fa-map-marker"></i></a>
                                                <a href="#" class="btn btn-link profile-btn-link" data-toggle="tooltip" data-placement="bottom" title="Add Photo"><i class="fa fa-camera"></i></a>
                                                <a href="#" class="btn btn-link profile-btn-link" data-toggle="tooltip" data-placement="bottom" title="Add File"><i class="fa fa-file"></i></a>
                                            </div>
                                        </form>
                                        ...
                                        <ul class="comment list-unstyled">
                                            <li class="comment">
                                                ...
                                                <!-- avatar -->
                                                <img class="avatar" src="assets/images/demo/thumb/small3.jpg" width="50" height="50" alt="avatar" />
                                            ...
                                            <li class="comment comment-reply">
                                                ...
                                                <!-- avatar -->
                                                <img class="avatar" src="assets/images/demo/thumb/small1.jpg" width="35" height="35" alt="avatar" />
                                        ...
                                        <ul class="comment list-unstyled">
                                            <li class="comment">
                                                ...
                                                <!-- avatar -->
                                                <img class="avatar" src="assets/images/demo/thumb/small4.jpg" width="50" height="50" alt="avatar" />
                                            ...
                                            <li class="comment comment-reply">
                                                ...
                                                <!-- avatar -->
                                                <img class="avatar" src="assets/images/demo/thumb/small3.jpg" width="35" height="35" alt="avatar" />
                                            ...
                                            <li class="comment comment-reply">
                                                ...
                                                <!-- avatar -->
                                                <img class="avatar" src="assets/images/demo/thumb/small5.jpg" width="35" height="35" alt="avatar" />
                                        ...
                                        <form class="form-horizontal">
                                            ...
                                            <fieldset>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" v-model="profile.firstname" class="form-control" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="profileLastName">Last Name</label>
                                                    <div class="col-md-8">
                                                        <input type="text" v-model="profile.lastname" class="form-control" id="profileLastName">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="profileAddress">Email</label>
                                                    <div class="col-md-8">
                                                        <input type="text" v-model="profile.email"  class="form-control" id="email">
                                                    </div>
                                                </div>
                                                <div class="form-group">
